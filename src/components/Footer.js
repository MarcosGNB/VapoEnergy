    ...
    <footer className="bg-black text-white py-12 px-6">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">VapoEnergy</h3>
            <p className="text-gray-400">Energiza tu experiencia de vapeo con nuestros productos premium.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Aviso de edad (+18)</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Políticas de privacidad</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>© {new Date().getFullYear()} VapoEnergy. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
